...
class ListingDetailImagesComponentTest : UiUnitTestBase() {
    ...
    fun should_show_listing_images() {
        listingImagesRobot
            ...
            .assertLayoutDisplayed()
            .assertLayoutDisplayed()
            .assertImageCount("1 of 3")
            .assertImage(position = 0)
            .assertPreviousButtonNotDisplayed()
            .assertNextButtonDisplayed()
            .swipeLeft()
            .assertImage(position = 1)
            .assertPreviousButtonDisplayed()
            .assertNextButtonDisplayed()
            .assertImageCount("2 of 3")
            .swipeLeft()
            .assertImage(position = 2)
            .assertPreviousButtonDisplayed()
            .assertNextButtonNotDisplayed()
            .assertImageCount("3 of 3")
            .swipeRight()
            .assertImage(position = 1)
            .assertPreviousButtonDisplayed()
            .assertNextButtonDisplayed()
