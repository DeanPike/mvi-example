...
class PropertyListingApiTest {
    ...
    fun `getFeedbackQuestions, returns Success`() = runTest {
        ...
        with(data.searchResults[1]) {
            ...
            assertThat(project.projectBannerImage).isEqualTo("https://images.domain.com.au/img/Agencys/devproject/banner_2842_240304_023807")
            assertThat(project.projectLogoImage).isEqualTo("https://images.domain.com.au/img/Agencys/devproject/logo_2842_240304_023807")
            assertThat(project.projectPriceFrom).isEqualTo(869000)
            assertThat(project.childListings.size).isEqualTo(2)

            assertThat(project.childListings[0].id).isEqualTo(2019090910)
            assertThat(project.childListings[0].dateListed).isEqualTo("2024-03-01T16:33:13+11:00")
            assertThat(project.childListings[0].lifecycleStatus).isEqualTo("New Home")
            assertThat(project.childListings[0].price).isEqualTo("$3,250,000")
            assertThat(project.childListings[0].bathroomCount).isEqualTo(3)
            assertThat(project.childListings[0].bedroomCount).isEqualTo(4)
            assertThat(project.childListings[0].carspaceCount).isEqualTo(2)
            assertThat(project.childListings[0].homepassEnabled).isFalse()
            assertThat(project.childListings[0].propertySize).isEqualTo("283m²")
            assertThat(project.childListings[0].earliestInspections!!.size).isEqualTo(2)
            assertThat(project.childListings[0].earliestInspections!![0].timeOpen).isEqualTo("2024-04-03T10:00:00")
            assertThat(project.childListings[0].earliestInspections!![0].timeClose).isEqualTo("2024-04-03T14:00:00")
            assertThat(project.childListings[0].earliestInspections!![0].recurrenceType).isEqualTo("weekly")
            assertThat(project.childListings[0].earliestInspections!![1].timeOpen).isEqualTo("2024-04-04T10:00:00")
            assertThat(project.childListings[0].earliestInspections!![1].timeClose).isEqualTo("2024-04-04T14:00:00")
            assertThat(project.childListings[0].earliestInspections!![1].recurrenceType).isEqualTo("weekly")

            assertThat(project.childListings[1].id).isEqualTo(2019090988)
            assertThat(project.childListings[1].dateListed).isEqualTo("2024-03-01T16:51:27+11:00")
            assertThat(project.childListings[1].lifecycleStatus).isEqualTo("New Home")
            assertThat(project.childListings[1].price).isEqualTo("$1,999,000")
            assertThat(project.childListings[1].bathroomCount).isEqualTo(3)
            assertThat(project.childListings[1].bedroomCount).isEqualTo(4)
            assertThat(project.childListings[1].carspaceCount).isEqualTo(2)
            assertThat(project.childListings[1].homepassEnabled).isFalse()
            assertThat(project.childListings[1].propertySize).isEqualTo("196m²")
            assertThat(project.childListings[1].earliestInspections!!.size).isEqualTo(2)
            assertThat(project.childListings[1].earliestInspections!![0].timeOpen).isEqualTo("2024-04-03T10:00:00")
            assertThat(project.childListings[1].earliestInspections!![0].timeClose).isEqualTo("2024-04-03T14:00:00")
            assertThat(project.childListings[1].earliestInspections!![0].recurrenceType).isEqualTo("weekly")
            assertThat(project.childListings[1].earliestInspections!![1].timeOpen).isEqualTo("2024-04-04T10:00:00")
            assertThat(project.childListings[1].earliestInspections!![1].timeClose).isEqualTo("2024-04-04T14:00:00")
            assertThat(project.childListings[1].earliestInspections!![1].recurrenceType).isEqualTo("weekly")

            assertThat(project.projectColorHex).isEqualTo("#00000d")
